...
exports.TerminateValidator = void 0;
...
let TerminateValidator = class TerminateValidator extends base_validator_1.BaseValidator {
    constructor(logger) {
        super(logger);
        this.logger = logger;
...
TerminateValidator = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [mculogger_service_1.MculoggerService])
], TerminateValidator);
exports.TerminateValidator = TerminateValidator;
//# sourceMappingURL=terminate.validator.js.map