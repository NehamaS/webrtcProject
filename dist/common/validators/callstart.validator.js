...
exports.CallStartValidator = void 0;
...
let CallStartValidator = class CallStartValidator extends base_validator_1.BaseValidator {
    constructor(logger) {
        super(logger);
        this.logger = logger;
...
CallStartValidator = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [mculogger_service_1.MculoggerService])
], CallStartValidator);
exports.CallStartValidator = CallStartValidator;
//# sourceMappingURL=callstart.validator.js.map