...
let RegisterValidator = class RegisterValidator extends base_validator_1.BaseValidator {
    constructor(logger) {
        super(logger);
        this.logger = logger;
    ...
    validate(dto) {
        let propertyList = ['protocolVersion', 'clientVersion', 'deviceId', 'deviceType'];
        this.propValidate(propertyList, dto.body);
    }
};
RegisterValidator = __decorate([
