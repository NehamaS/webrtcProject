...
export class RestcommSimulator implements OnModuleInit, OnModuleDestroy{

    public async onModuleInit(){
        console.log("SIP servert listen on ip: %s, port: %d", serverIp, serverSipPort);
        sip.start({ protocol: 'UDP', address: serverIp, port: serverSipPort }, this.onSipMsgReq.bind(this));
    }
